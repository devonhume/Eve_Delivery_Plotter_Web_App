...
dbhandler = db_handler.DbHandler(db)
check_dict = {}
...
def get_sys_id(sys_name):
    ...
    return dbhandler.get_system_id(sys_name)
...
def get_sys_name(sys_id):
    ...
    return dbhandler.get_system_name(sys_id)

class Character:

    def __init__(self, name, current_system):
        self.name = name
...
class System:
    ...
    def get_stargates(self):
        return dbhandler.get_gates(self.system_id)
...
class Player:
    ...
    def get_next_jump(self, agents, missions):
        ...
        # If no agents or systems, return None
